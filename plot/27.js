function draw27(myChart,ckey,height,titles,xname,yname,width,div,border,zindex,legends) {
  if(legends == 'left'){
    var legendss=true;
  ...
  if(legends == 'false'){
    ...
    option={
        ...
        xAxis: {
            ...
            name:xname,
            data:[],
            nameTextStyle:e_areastack_textstyle,
            splitLine:{
                show:false
            },
            axisLine:{
            ...
            boundaryGap : false,
            axisLabel:{
               textStyle:e_areastack_textstyle
            }
        },
        yAxis: {
            type: 'value',
