function draw06(myChart,ckey,height,titles,x,y,width,div,border,zindex,legends){
    var timeDatas = new Date().getTime();
    // console.log(timeDatas);
    var run_body=$('<div id="box_run" style="100%">'+
    ...
    $(".table-all"+timeDatas+",.table-title"+timeDatas).css("width",width);
