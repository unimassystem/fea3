function draw65(myChart,ckey,height,titles,xname,yname,width,div,border,zindex,legends){
  if(legends == 'left'){
    var legendss=true;
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            for(var i=0;i<data.length;i++){
                    ...
                    chinaData1[i] = [{name:china1,value:data[i][7]}, {name:china,value:value}];
