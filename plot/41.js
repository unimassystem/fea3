function draw41(myChart,ckey,height,titles,xname,yname,width,div){
    $.ajax({
        type : 'get',
        ...
        success:function (dataAll){
            ...
            option = {
                ...
                series : [
                {
                    ...
                    radius: '85%',
                    axisLine: {  
                        lineStyle: e_gauge_linecolor,// 坐标轴线
                ...
                },
                {
                    ...
                    splitNumber:2,
                    axisLine: {            // 坐标轴线
                        lineStyle: e_gauge_linecolor_left,
                    },
                    axisLabel: {            // 坐标轴小标记
                        textStyle: {       // 属性lineStyle控制线条样式
                            // fontWeight: 'bolder',
                ...
                },
                {
                    ...
                    splitNumber:2,
                    axisLine: {            // 坐标轴线
                        lineStyle: e_gauge_linecolor_right,
                    },
                    axisLabel: {            // 坐标轴小标记
                        textStyle: {       // 属性lineStyle控制线条样式
                            // fontWeight: 'bolder',
                    ...
                    data:[{value:data[2][0], name:data[2][1]}]
                }
            ]
            }  
