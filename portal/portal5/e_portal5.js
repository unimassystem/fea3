...
function getBorder(type){
    ...
    var noBorders = [8,10,13,15,18,22,24,29];//无边框图形
    if(shuzhi > 300){
        return 'no_border';
...
/*-------------------------------------------折线图----------------------------------*/
 //4.10新增折线图线条样式(此颜色配置不包含图例颜色，因此会导致图例和线条显色不对应的问题出现)
...
var e_lineglobal_color=['#e9dd06','#00f3fc','#4249ca'];
...
//--------------------------面积图--------------------------
//面积图全局颜色
var e_areaglobal_color=['#e9dd06','#00f3fc','#4249ca','#24f7ff','#396858'];

//面积图面积颜色在 0 处时的颜色
var e_areastyle_0color=['#e9dd06','#00f3fc','#4249ca','#24f7ff','#396858'];

//面积图面积颜色在 1 处时的颜色
var e_areastyle_1color=['#e9dd06','#00f3fc','#4249ca','#24f7ff','#396858'];

//新增面积图线条颜色
var e_arealine_color=['#e9dd06','#00f3fc','#4249ca','#24f7ff','#396858'];


//-------------------------多颜色单数据柱状图-----------------------
var e_itemnormal_color=['#a0ba4f','#94581a','#0dd3c2','#23649c','#0c5f65','#258458','#055a76','#415d5e','#4e5a4c','#64417b'];
...
// 直角系以及饼图颜色循环
var e_angle_color=['rgb(24,154,202)','rgb(53,121,129)','rgb(146,142,102)','rgb(12,137,97)','rgb(20,52,97)'];
...
//----阴影颜色
var e_pie_mr_shadowColor_1='rgba(14,48,67,1)';
var e_pie_mr_shadowColor_2='rgba(14,48,67,1)';
/*渐变内外环*/
// //饼图渐变颜色内部线性环
// var e_pie_color_type_1='linear';/*线性*//*type: 'radial' 经向*/
// var e_pie_color_jb1_1=['red','blue','#086f78'];
// var e_pie_color_jb2_1=['#d3c637','#0d8f07','#045b48'];

var e_pie_color_jb1_1=['red'];
var e_pie_color_jb2_1=['#d3c637'];

var e_pie_color_type_2='linear';/*线性*//*type: 'radial' 经向*/
// var e_pie_color_jb1_2=['#086f78','#0d8f07','#0d8f07'];
// var e_pie_color_jb2_2=['#d3c637','#045b48','#045b48'];
var e_pie_color_jb1_2=['#086f78'];
var e_pie_color_jb2_2=['#d3c637'];




//----柱线图渐变颜色
var e_bar_color_jb1=["#f0ff01",'#d4d100','#8b1899','#86a8ff','#00ffe4'];  // 0% 处的颜色
var e_bar_color_jb2=['rgba(0,183,181,0.01)','rgba(207,0,0,0.4)','rgba(0,157,151,0.31)','#1a00b7','#aa2c0f']; // 100% 处的颜色
...
//-----柱线图阴影颜色
var e_bar_zx_shadowColor='#004490';
...
//---背景颜色---
var e_hot_back='rgba(38,137,175,0.2)';
//---坐标轴样式---
var e_hot_textstyle={
	color:'#f0f0f0',
	fontSize:12
